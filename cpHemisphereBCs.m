function [cpx,cpy,cpz, dist, bdy, bdyBCs] = cpHemisphereBCs(x,y,z, R, cen)
...
%   Code is vectorized: any size/shape for x should work.
  ...
  % divide into quadrants to apply BCs
  bdy1 = (z < 0 & th >= 0 & th < pi/2);
  bdy2 = (z < 0 & th >= pi/2 & th < pi);
  bdy3 = (z < 0 & th >= -pi & th < -pi/2);
  bdy4 = (z < 0 & th >= -pi/2 & th < 0);
  bdy1 = bdy1(:); bdy2 = bdy2(:); bdy3 = bdy3(:); bdy4 = bdy4(:);
