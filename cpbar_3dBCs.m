function [cpx,cpy,cpz, dist, bdy,bdyBCs] = cpbar_3dBCs(x,y,z, f, varargin)
...
[cpx,cpy,cpz, dist, bdy, bdyBCs] = f(x,y,z, varargin{:});
...
[cpx(lbdy), cpy(lbdy), cpz(lbdy), tilde, tilde, tilde] = f(x2,y2,z2, varargin{:});
